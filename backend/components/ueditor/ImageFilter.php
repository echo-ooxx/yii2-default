...
class ImageFilter {
    ...
    private $marktext = 'www.dinzd.com';
    ...
    function __construct($sourceaddress, $job = null, $endaddress = "") {
        $this->sourceaddress = $sourceaddress['tmp_name'];
        $this->image = $this->imagesources($sourceaddress['tmp_name']);
...
//            $endaddress = $path . $this->suffix . '.' . $ext;
//        } else {
...
//1=GIF,2=JPG,3=PNG,4=SWF,5=PSD,6=BMP,7=TIFF(intel byte order),8=TIFF(motorola byte order),9=JPC,10=JP2,11=JPX,12=JB2,13=SWC,14=IFF,15=WBMP,16=XBM
    ...
    private function watermark($args = null) {
        ...
        //加水印
        $alpha = 0;//水印透明度
//        imagecopymerge($this->image, $this->imagesources($mark_file), $positionarr[0], $positionarr[1], 0, 0, $imagearrs[0], $imagearrs[1],$alpha);
        $this->imagecopymerge_alpha($this->image, $this->imagesources($mark_file), $positionarr[0], $positionarr[1], 0, 0, $imagearrs[0], $imagearrs[1],$alpha);
...
//
        switch ($num) {
            ...
            case 9:
                ...
                break;
            case 0:
                $positionarr[0] = $this->width - $width - 30;
                $positionarr[1] = $this->height - $height - 20;
                break;
        }
        return $positionarr;
    }
