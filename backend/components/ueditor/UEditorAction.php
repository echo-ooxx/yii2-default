...
class UEditorAction extends Action
{
    ...
    public function init()
    {
        ...
        $this->config['isAddWater'] = $this->isAddWater;
        parent::init();
    }
        ...
        switch (htmlspecialchars($_GET['action'])) {
            case 'uploadimage':
                $config = array(
                    ...
                    "isAddWater" => $this->config['isAddWater'],
                    'uploadFormatPath' => $this->config['imagePathFormat']
                );
            ...
            case 'uploadscrawl':
                ...
                $fieldName = $this->config['scrawlPathFormat'];
                $base64 = "base64";
                break;
            case 'uploadvideo':
                $config = array(
                    ...
                    'uploadFormatPath' => $this->config['videoPathFormat']
                );
            ...
            default:
                $config = array(
                    ...
                    'uploadFormatPath' => $this->config['filePathFormat']
                );
